...
public class Message implements Serializable {
	...
	private String nomesJogadoresConectadosGSON; //objeto GSON com os nomes dos jogadores
	
	private String mapJogadoresPecasCorrentesGSON; //objeto GSON com o HashMap dos jogadores e suas respectivas pecas correntes 
	...
	//GSON
	public void setNomesJogadoresConectadosGSON(String nomesJogadoresConectadosGSON){
	...
	public void setMapJogadoresPecasCorrentesGSON(String mapJogadoresPecasCorrentesGSON) {
	...
	public String toString() {	
		return "Mensagem: [nomeJogador = " + nomeJogador + "], [acao = " + acao.name() +"], [mensagemChat = " + mensagemChat +"], [nomesJogadoresConectados = " 
			+ nomesJogadoresConectadosGSON +"], [mapJogadoresPecas = " + mapJogadoresPecasCorrentesGSON +"]";
	}
