...
public class Player extends JFrame {
	...
	/* classe serializada, responsável por armazenar
	 * as informações/mensagens que são trocadas entre
	 * cliente <-> servidor */
		...
		jPanel1Layout.setHorizontalGroup(
				...
				.addGroup(jPanel1Layout.createSequentialGroup()
						...
						.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
								.addGroup(jPanel1Layout.createSequentialGroup()
										.addComponent(labelPieces)
										.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
										.addComponent(textFieldPieces))
										.addGroup(jPanel1Layout.createSequentialGroup()
												.addComponent(labelMesa)
												.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
												.addComponent(textFieldTable))
												.addGroup(jPanel1Layout.createSequentialGroup()
														.addComponent(labelTurn)
														.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
														.addComponent(textFieldTurn, GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE)
														.addGap(18, 18, 18)
														...
														.addGap(18, 18, 18)
														.addComponent(buttonMakeTurn, GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE)))
														.addContainerGap())
				);
		jPanel1Layout.setVerticalGroup(
				...
				.addGroup(jPanel1Layout.createSequentialGroup()
						...
						.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
								.addComponent(labelMesa)
								.addComponent(textFieldTable, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 24, Short.MAX_VALUE)
								.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
										.addComponent(labelPieces)
										.addComponent(textFieldPieces, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
										.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
												.addGroup(jPanel1Layout.createSequentialGroup()
														.addGap(25, 25, 25)
														.addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
																.addComponent(labelTurn)
																.addComponent(textFieldTurn, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
																.addComponent(labelSide)
																.addComponent(radioLeft)
																.addComponent(radioRight)))
																.addGroup(jPanel1Layout.createSequentialGroup()
																		.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
																		.addComponent(buttonMakeTurn, GroupLayout.PREFERRED_SIZE, 65, GroupLayout.PREFERRED_SIZE)))
																		.addContainerGap())
				);
												...
												.addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
														.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
																.addGroup(layout.createSequentialGroup()
																		...
																		.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
																		.addComponent(textFieldUrl, GroupLayout.PREFERRED_SIZE, 138, GroupLayout.PREFERRED_SIZE))
																		.addGroup(layout.createSequentialGroup()
																				...
																				.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
																						.addGroup(layout.createSequentialGroup()
																								.addGap(10, 10, 10)
																								.addComponent(buttonStartGame, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
																								.addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
																										.addComponent(labelPort)
																										.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
																										.addComponent(textFieldPort, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE))))
																										.addComponent(jScrollPane3))
																										.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
																										.addComponent(paneChat, GroupLayout.PREFERRED_SIZE, 512, GroupLayout.PREFERRED_SIZE)))
						...
						.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
								.addGroup(layout.createSequentialGroup()
										.addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
												.addComponent(labelPlayerName)
												.addComponent(textFieldPlayerName, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												...
												.addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
														...
														.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
														.addComponent(jScrollPane3, GroupLayout.PREFERRED_SIZE, 68, GroupLayout.PREFERRED_SIZE)
														.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
	...
	private void buttonStartGameActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			...
			//System.out.println("JOGADOR " + nome + ": enviou a mensagem de chat para o servidor: " + mensagem.getMensagemChat());
	...
	private void buttonSendChatActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (!textFieldMessage.getText().equals("")) {
			...
			/* montando a mensagem a ser entregue [nome do jogador que envia e mensagem]*/	
			message.setAcao(Acao.CHAT); //acao que definirá o que está acontecendo nessa troca de mensagem
			message.setNomeJogador(userName);	
			...
			try {
				...
				System.out.println("JOGADOR " + userName + ": enviou a mensagem de chat para o servidor: " + message.getMensagemChat());
	...
	private void conectarNoServidor(){
		...
		try{
			...
			JOptionPane.showMessageDialog(this, "Jogador " + userName + " conectado no Servidor DomiNóis!");

			/* streams de mensagens (cliente <-> servidor) */
			inicializarFluxosMensagens();

			new Thread(new ThreadActionPlayer()).start(); //TODO se conseguir desacoplar
			
			buttonConnect.setEnabled(false);

		}catch(Exception e){
			JOptionPane.showMessageDialog(this, "Erro ao conectar no servidor: " + e);
		}	
	}


	/* responsável por fazer a conexão do escritor e leitor do cliente,
	 * com o comunicador e receptor do servidor */
	private void inicializarFluxosMensagens() {
		try {	
			...
			outToServerStream = new ObjectOutputStream(socketCliente.getOutputStream());
			fromServerStream = new ObjectInputStream(socketCliente.getInputStream());	
	...
	/* enquanto a tela de jogador estiver aberta, uma thread com um while fica monitorando as alterações,
	 * em paralelo, na entrada do stream do cliente (mensagens virão da saída do servidor) */
	private class ThreadActionPlayer implements Runnable{  
		...
		public void run() {
			...
			/* monitorando quando uma mensagem na porta de entrada for recebida do servidor (loop de análise)*/
			while (true) {			
				...
				try {
					...
					System.out.println("JOGADOR "+ userName +": Recebi mensagem do servidor: " + message);	
				...
				//LOGICAS		
				/* análise de qual ação tomar de acordo com a "carta" vinda do servidor */
				...
				/* atualizando a área dos nomes de jogadores jogadores (quando adicionado) */
				if(message.getAcao().equals(Acao.JOGADOR_ADICIONADO)){		

					clearTextAreaPlayersNames();
				
					List<String> nomesJogadoresConectados = 
							gson.fromJson(message.getNomesJogadoresConectadosGSON(), ArrayList.class);

					//para cada nome vindo da mensagem	
					Collections.sort(nomesJogadoresConectados); //ordem alfabética
					for(String nomeJogador : nomesJogadoresConectados){
						addPlayerNameInTextAreaPlayersNames(nomeJogador); //adicionar no elemento GUI
					}
				}
				...
				if(message.getAcao().equals(Acao.JOGO_INICIADO)){
					...
					try{
						...
						JOptionPane.showMessageDialog(null, "O jogo foi iniciado pelo jogador " + message.getNomeJogador());

						//carregar peças sorteadas vindo da mensagem no GUI
						
						//desserializando o HashMap passado via Mensagem (do servidor)	
						Map<Integer,List<DominoPiece>> mapJogadoresPecas = 
										deserializeMap(message.getMapJogadoresPecasCorrentesGSON());

						//setando as peças de acordo com a porta local do cliente
						Integer portaLocal = socketCliente.getLocalPort();

						List<DominoPiece> pecasCorrentes = mapJogadoresPecas.get(portaLocal);

						setTextFieldPieces(pecasCorrentes.toString()); //elemento GUI
	    ...
	    private void addMessageInChat(Message message){
			textAreaChat.append(message.getNomeJogador() + ": " + message.getMensagemChat() + "\n");			
	    }
		...
		private Map<Integer, List<DominoPiece>> deserializeMap(String serializableString){
			java.lang.reflect.Type mapType = new TypeToken<Map<Integer, List<DominoPiece>>>(){}.getType();			
